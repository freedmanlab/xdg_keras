...
class MultiStimulus:
    ...
    def generate_trial(self, current_task):
        ...
        return task[1], self.trial_info['neural_input'].astype(np.float32), self.trial_info['desired_output'], \
            self.trial_info['train_mask'].astype(np.float32), self.trial_info['reward_data']
